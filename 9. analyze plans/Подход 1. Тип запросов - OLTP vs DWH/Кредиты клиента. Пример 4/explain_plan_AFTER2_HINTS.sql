...
-----------------------------------------------------------------------------------------------------------------------
|   0 | SELECT STATEMENT                       |                              |     1 |    44 |  5646   (1)| 00:00:01 |
|   1 |  SORT AGGREGATE                        |                              |     1 |    44 |            |          |
|   2 |   NESTED LOOPS                         |                              |  6747 |   289K|  5646   (1)| 00:00:01 |
|   3 |    NESTED LOOPS                        |                              |  6747 |   289K|  5646   (1)| 00:00:01 |
|   4 |     TABLE ACCESS BY INDEX ROWID BATCHED| CLIENT_CREDIT                |  6747 |   144K|    73   (0)| 00:00:01 |
|*  5 |      INDEX RANGE SCAN                  | CLIENT_CREDIT_CREATE_DTIME_I |  6747 |       |    23   (0)| 00:00:01 |
...
---------------------------------------------------
   ...
   5 - access("CC"."CREATE_DTIME">=ADD_MONTHS(SYSDATE@!,(-12)))
